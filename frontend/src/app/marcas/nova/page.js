    ...
    return (
        <main className="min-h-screen bg-[#fcfbf8] pb-24">
            ...
            <div className="flex items-center gap-3 px-4 py-4 bg-white border-b border-slate-200 sticky top-0 z-10">
                ...
                <h1 className="text-lg font-bold text-slate-800">Nova Marca</h1>
            </div>
            ...
            <form onSubmit={handleSalvar} className="px-4 pt-2 pb-6 space-y-1">
                ...
                {/* Nome da Marca */}
                <div className="pt-4">
                    <label className="text-[11px] font-semibold tracking-wide text-[#008080] uppercase block mb-1">Nome da Marca</label>
                    <input
                        type="text"
                        required
                        placeholder="Ex: HTH, Genco..."
                        value={nome}
